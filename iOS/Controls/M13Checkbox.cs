...
namespace MultiPokeListView.iOS.Controls
{
    ...
    {
        static System.nfloat DefaultHeight = (System.nfloat)24.0;
        static System.nfloat kBoxRadius = (System.nfloat)0.1875;
        static System.nfloat kBoxStrokeWidth = (System.nfloat)0.05;
        ...
        public M13Checkbox()
            :this( new CGRect(0, 0, DefaultHeight, DefaultHeight))
        {
        }
...
//        }
        ...
        void Setup()
        {
            ...
            StrokeWidth = kBoxStrokeWidth * heightForCheckbox;
            ...
            Radius = kBoxRadius * heightForCheckbox;
            ...
            var checkViewFrame = new CGRect(
                Frame.Size.Width - ((kBoxSize + kCheckHorizontalExtention) * heightForCheckbox),
                (Frame.Size.Height - ((kBoxSize + kCheckHorizontalExtention) * heightForCheckbox)) / (System.nfloat)2.0,
            ...
            CGRect labelFrame = new CGRect(
                0,
                0,
                Frame.Size.Width - CheckView.Frame.Size.Width - (heightForCheckbox * kCheckBoxSpacing),
                Frame.Size.Height)
                .Integral();
        ...
        void LayoutSubviews()
        {
            ...
            {     
                CheckView.Frame = new CGRect(
                    (TitleLabel.Text.Length == 0 ? 0 : Frame.Size.Width - ((kBoxSize + kCheckHorizontalExtention) * heightForCheckbox)),
                    (Frame.Size.Height - ((kBoxSize + kCheckHorizontalExtention) * heightForCheckbox)) / 2.0,
                    ((kBoxSize + kCheckHorizontalExtention) * heightForCheckbox),
                    heightForCheckbox)
                    .Integral();
                ...
                TitleLabel.Frame = new CGRect(
                    0,
                    0,
                    Frame.Size.Width - (heightForCheckbox * (kBoxSize + kCheckHorizontalExtention + kCheckBoxSpacing)),
                    Frame.Size.Height)
                    .Integral();
            } else {
...
//                    self.frame.size.height));
        ...
        public event CheckedChangedEventHandler ChechedChanged;
        public void SetCheckState(CheckState checkState)
        {
            CheckState = checkState;
            if (ChechedChanged != null)
            {
                ChechedChanged(this, CheckState == CheckState.Checked);
            }
